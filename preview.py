...
def main() -> int:
    ...
    if admitted and total_trades == 0:
        ...
        print("VERDICT: [OK] You clear admission's safety bar -- you're very likely to be ADMITTED.")
        print("         Push your repo + email submit@builderr.ai to lock in your official run.")
    else:
        print("VERDICT: [X] Not yet. Fix the FAIL line(s) above -- those are the same limits the real")
